...
const EmptySlot: FunctionComponent = () => {
  return (
    <div className="self-stretch h-[68px] relative max-w-full">
      <footer className="absolute top-[34px] left-[0px] w-[390px] overflow-hidden flex flex-row items-start justify-center pt-5 px-5 pb-[9px] box-border max-w-full">
